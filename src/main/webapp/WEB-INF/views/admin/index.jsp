...
<head>
    ...
    <script src="<c:url value='/styles/dwz/js/jquery-2.1.4.js'/>" type="text/javascript"></script>
    ...
    <script src="<c:url value='/styles/dwz/xheditor/xheditor-1.2.2.min.js'/>" type="text/javascript"></script>
    <script src="<c:url value='/styles/dwz/xheditor/xheditor_lang/zh-cn.js'/>" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            DWZ.init("<c:url value='/styles/dwz/dwz.frag.xml'/>", {
                ...
                loginUrl:"<c:url value='/WEB-INF/views/admin/login.jsp' />",	// 跳到登录页面
...
<div id="layout">
    ...
    <div id="leftside">
        ...
        <div id="sidebar">
            <div class="toggleCollapse"><h2>后台管理</h2><div>collapse</div></div>
